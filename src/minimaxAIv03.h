// Copyright 2036 ghooo (https://github.com/ghooo)
...
#ifndef MINIMAXAIV03_H
#define MINIMAXAIV03_H

#include "botAI.h"

class MinimaxAIv03: public BotAI {
public:
	MinimaxAIv03(Field* field) : BotAI(field) {
